...
public class InvPriceChangeDetailController implements Initializable, ControlledScreen  {
    ...
    private double _srp;
    private double _new_cost;
    private double _new_srp;
    ...
    public void setNewCost(double fnValue){
        _new_cost = fnValue;
    }  
    
    public void setNewSRP(double fnValue){
        _new_srp = fnValue;
    }  
    ...
    private void initFields(){
        ...
        txtDetail05.setText(StringUtil.NumberFormat(_srp, "#,##0.00"));
        txtDetail06.setText(StringUtil.NumberFormat(_new_cost, "#,##0.00"));
        txtDetail07.setText(StringUtil.NumberFormat(_new_srp, "#,##0.00"));
    ...
    private void loadData(){        
        //load the data
        _callback.Result(_row, "nUnitPrce", _new_cost);
        _callback.Result(_row, "nSelPrce1", _new_srp);
        ...
        if(!nv){
            switch (lnIndex){
                case 6:
                    ...
                    _new_cost = Double.valueOf(txtField.getText());
                    txtDetail06.setText(StringUtil.NumberFormat(_new_cost, "#,##0.00"));
                    break;
                case 7:
                    if (StringUtil.isNumeric(lsValue))                    
                    ...
                    _new_srp = Double.valueOf(txtField.getText());
                    txtDetail07.setText(StringUtil.NumberFormat(_new_srp, "#,##0.00"));
                    break;
            }
        }
