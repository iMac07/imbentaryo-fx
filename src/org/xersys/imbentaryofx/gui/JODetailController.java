...
public class JODetailController implements Initializable, ControlledScreen  {
    ...
    public void setIssuedQty(int fnValue){
        _issued = fnValue;
    }
    ...
    private void initFields(){
        ...
        txtDetail09.setOnKeyPressed(this::txtField_KeyPressed);
        ...
        txtDetail09.focusedProperty().addListener(txtField_Focus);
        ...
        txtDetail06.setDisable(((int) _nautilus.getUserInfo("nObjAcces") & AccessLevel.SALES) == 0);
        txtDetail09.setDisable(((int) _nautilus.getUserInfo("nObjAcces") & AccessLevel.INVENTORY) == 0);
    ...
    private void loadData(){
        ...
        _callback.Result(_row, "nIssuedxx", _issued);
            ...
            switch (lnIndex){
                case 6:
                    if (StringUtil.isNumeric(lsValue))                    
                        if (Integer.parseInt(lsValue) < _issued){
                            ShowMessageFX.Warning(_main_screen_controller.getStage(), "Order was less than the issued item. Please ask the warehouse personnel to update the issued quantity.", "Warning", "");
                            txtField.setText(String.valueOf(_issued));
                        } else txtField.setText(lsValue);                    
                    else{
                ...
                case 9:
                    if (StringUtil.isNumeric(lsValue))                    
                        if (Integer.parseInt(lsValue) > _order){
                            ShowMessageFX.Warning(_main_screen_controller.getStage(), "Issued quantity is more than the order. Please ask the sales personnel to update the order.", "Warning", "");
                            txtField.setText(String.valueOf(_order));
                        } else txtField.setText(lsValue);                    
                    else{
                        ShowMessageFX.Warning(_main_screen_controller.getStage(), "Please encode a numeric value with correct format.", "Warning", "");
                        txtField.setText("0");
                    ...
                    _issued = Integer.parseInt(txtField.getText());
                    break;
                case 7:
                    if (StringUtil.isNumeric(lsValue)){
