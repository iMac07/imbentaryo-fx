 ...
 * @author user1
 */
public class TownController implements Initializable, ParameterControlledScreen{
    ...
    @FXML
    private AnchorPane AnchorTownMain;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {        
        ...
        AnchorTownMain.setTopAnchor(AnchorTownMain, 0.0);
        AnchorTownMain.setBottomAnchor(AnchorTownMain, 0.0);
        AnchorTownMain.setLeftAnchor(AnchorTownMain, 0.0);
        AnchorTownMain.setRightAnchor(AnchorTownMain, 0.0);  
