...
import org.xersys.clients.base.ClientMobile;
...
public class ClientMobileController implements Initializable, ControlledScreen{
    ...
    public void initialize(URL url, ResourceBundle rb) {        
        ...
        _trans = new ClientMobile(_nautilus);     
        ...
        try {
            for(lnCtr = 0; lnCtr <= lnRow -1; lnCtr++){           
                _table_data.add(new TableModel(String.valueOf(lnCtr + 1), 
                            (String) _trans.getDetail(lnCtr, "sMobileNo"),
                            String.valueOf(_trans.getDetail(lnCtr, "nPriority")), 
                            ((String) _trans.getDetail(lnCtr, "cIncdMktg")).equals("1") ? "Yes" : "No",
    ...
    private void setDetailInfo(int fnRow){
        try {
            txtField01.setText((String) _trans.getDetail(fnRow, "sMobileNo"));
            txtField02.setText(String.valueOf(_trans.getDetail(fnRow, "nPriority")));

            chkMarketing.setSelected("1".equals((String) _trans.getDetail(fnRow, "cIncdMktg")));
    ...
    private void initGrid(){
        ...
        index04.setText("Incld. Mktg."); 
        index04.setCellValueFactory(new PropertyValueFactory<TableModel,String>("index04"));
        index04.prefWidthProperty().set(80);
        
        index05.setText("Active"); 
    ...
    private void initButton(){
        ...
        chkMarketing.setOnAction(this::chkMarketing);
