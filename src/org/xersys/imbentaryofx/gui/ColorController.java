 ...
 * @author user1
 */
public class ColorController implements Initializable, ParameterControlledScreen{
    ...
    @FXML
    private AnchorPane AnchorColorMain;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {        
        ...
        AnchorColorMain.setTopAnchor(AnchorColorMain, 0.0);
        AnchorColorMain.setBottomAnchor(AnchorColorMain, 0.0);
        AnchorColorMain.setLeftAnchor(AnchorColorMain, 0.0);
        AnchorColorMain.setRightAnchor(AnchorColorMain, 0.0);  
