 ...
 * @author user1
 */
public class ParameterScreenController {
    ...
    public ParameterScreenController() {
        super();
    }
    ...
    public boolean loadScreen(String resource, ParameterControlledScreen controller) {
        try {
    ...
    //loads the fxml file, add the screen to the screens collection and
    //finally injects the screenPane to the controller.
    public boolean loadScreen(Nautilus nautilus, String resource, ParameterControlledScreen controller) {
        try {
            FXMLLoader myLoader = new FXMLLoader();
