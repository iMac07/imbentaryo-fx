 ...
 * @author user1
 */
public class ProvinceController implements Initializable, ParameterControlledScreen{
    ...
    @FXML
    private AnchorPane AnchorProvinceMain;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {        
        ...
        AnchorProvinceMain.setTopAnchor(AnchorProvinceMain, 0.0);
        AnchorProvinceMain.setBottomAnchor(AnchorProvinceMain, 0.0);
        AnchorProvinceMain.setLeftAnchor(AnchorProvinceMain, 0.0);
        AnchorProvinceMain.setRightAnchor(AnchorProvinceMain, 0.0);  
