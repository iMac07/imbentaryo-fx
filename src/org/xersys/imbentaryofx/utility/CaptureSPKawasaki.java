...
public class CaptureSPKawasaki {
    public static void main(String [] args){
        final String BRANDCODE = "KAWASAKI";
        ...
        try  {  
            File file = new File("d:/icarus/temp/Copy of KAWASAKI Price List as of January 24 2023.xlsx");   //creating a new file instance  
