...
public class testBrand {
    public static void main(String [] args){
        ...
        Brand instance = new Brand(loNautilus, (String) loNautilus.getBranchConfig("sBranchCd"), false);
        instance.setListener(_listener);
        
        if (instance.NewRecord()) {
            instance.setMaster("sBrandCde", "MAC");
            instance.setMaster("sDescript", "Michael Cuison");
            instance.setMaster("sInvTypCd", "MC"); //sInvTypCd
