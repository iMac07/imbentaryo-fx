...
public class testModel {
    public static void main(String [] args){
        ...
        Model instance = new Model(loNautilus, (String) loNautilus.getBranchConfig("sBranchCd"), false);
        instance.setListener(_listener);
        
        if (instance.NewRecord()) {
            instance.setMaster("sModelCde", "111111");
            instance.setMaster("sBriefDsc", "Mac");
            instance.setMaster("sDescript", "Michael Torres Cuison");
            instance.setMaster("sModelNme", "Michael Cuison");
            instance.setMaster("sBrandCde", "MAC"); //a.sBrandCde
